const global = {
  ...
  api: {
    apiKey: "70b07f3cc7d299ecfb14a747501da5c0",
  ...
  results.forEach((show) => {
    ...
    div.innerHTML = `
        ...
        <div class="movie-title">
            ...
            <p><small>Air Date: ${show.first_air_date}</small></p>
...
async function displayMovieDetails() {
  ...
  //put moviedetails html inside this div
  div.innerHTML = `
...
async function displayShowDetails() {
  ...
  //put showtails html inside this div
  div.innerHTML = `
     <div class="details-top">
          <div>
            ${
...
// Create & Display Paginatiom for Search
